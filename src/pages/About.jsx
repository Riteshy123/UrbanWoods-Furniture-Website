        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="lg:w-1/2 mb-8 lg:mb-0"> 
              ...
              <p className="mt-8 text-black">For inquiries, feel free to contact us at: <a href="tel:+919161742417">
                <b><br />+91 9161742417 <br /> +91 9670142221 <br/>+91 9899970493</b></a></p>
            </div>
